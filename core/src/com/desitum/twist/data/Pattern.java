...
public class Pattern {
    ...
    private static ArrayList<Bar> loadPattern4()
    {
        ...
        Bar pattern4_bar1 = new Bar(7, 4, Bar.HORIZONTAL, new float[]{0, 0}, Assets.purpleBarTexture);
        Bar pattern4_bar2 = new Bar(7, 4, Bar.HORIZONTAL, new float[]{8, 3}, Assets.purpleBarTexture);
        Bar pattern4_bar3 = new Bar(7, 4, Bar.HORIZONTAL, new float[]{0, 6}, Assets.purpleBarTexture);
        Bar pattern4_bar4 = new Bar(7, 4, Bar.HORIZONTAL, new float[]{8, 9}, Assets.purpleBarTexture);
    ...
    private static ArrayList<Bar> loadPattern6()
    {
        ...
        Bar pattern6_bar1 = new Bar(2, 4, Bar.VERTICAL, new float[]{1, 10}, Assets.yellowBarTexture);
        pattern6_bar1.setBarStoppingPointTop(10);
        pattern6_bar1.setBarStoppingPointBottom(0);
        Bar pattern6_bar2 = new Bar(2, 4, Bar.VERTICAL, new float[]{3, 5}, Assets.yellowBarTexture);
        ...
        Bar pattern6_bar4 = new Bar(2, 3, Bar.HORIZONTAL, new float[]{5, 3}, Assets.yellowBarTexture);
    ...
    private static ArrayList<Bar> loadPattern9()
    {
        ...
        Bar pattern9_bar2 = new Bar(4, 3, Bar.HORIZONTAL, new float[]{0, 4.5f}, Assets.blueBarTexture);
        pattern9_bar2.setBarStoppingPointRight(5);
        Bar pattern9_bar3 = new Bar(4, 3, Bar.HORIZONTAL, new float[]{7, 4.5f}, Assets.blueBarTexture);
